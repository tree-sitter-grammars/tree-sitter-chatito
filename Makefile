LANGUAGE_NAME := tree-sitter-chatito
HOMEPAGE_URL := https://github.com/tree-sitter-grammars/tree-sitter-chatito
VERSION := 0.4.0
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/chatito \
		'$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/chatito
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/chatito
