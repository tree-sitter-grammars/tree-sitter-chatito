...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [302] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 3, .production_id = 4),
